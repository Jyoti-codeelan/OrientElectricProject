...
public class JavaScriptUtils {
	...
	public void doclickElementByJS(WebElement element) {
		JavascriptExecutor js = ((JavascriptExecutor) driver);
	...
	public void checkPageIsReady() throws InterruptedException {
	 ...
	 /**********  Select date using JavascriptExecutr   **************/ 
	 
	 public void selectDateFromCalendarJSE(By locator,String dateValue) {
  	  
  	  JavascriptExecutor js= ((JavascriptExecutor)driver);
  	  js.executeScript("arguments[0].setAttribute('value','"+dateValue+"');", locator);
